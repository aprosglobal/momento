    ...
    <div class="wancho">
        ...
        <div class="b3-wrap-select g3-move-up-1">
            <div class="b3-inner-select">
                ...
                <div class="b3-select">
                    <select class="b3-select-distrito b3-select-filter">
                        ...
                        <?php
                        while ($districtsList->have_posts()):
                            $districtsList->the_post();
                ...
                while ($proyectos_meters->have_posts()):
                    $proyectos_meters->the_post();
                ...
                <div class="b3-select">
                    <select class="b3-select-architects b3-select-filter">
                        ...
                        <?php
                        while ($architectsList->have_posts()):
                            $architectsList->the_post();
            ...
            <div class="b3-wrap-clearfilters" style="display:none">
                <a href="" class="b3-clear-filter"><span><?php _e('Limpiar Filtros', 'staff'); ?></span> <i
        ...
        <div class="wancho">
            <div class="b23-fila-top">
                ...
                <div class="g0-cnt-btn">
                    <a href="<?php echo get_permalink(333) ?>" class="b23-link"><i
    ...
    <section class="b5 g3-anima">
        <div class="wancho">
            <div class="b5-top g3-move-up-1">
                ...
                <div class="g0-cnt-btn">
                    <a href="<?php echo get_permalink(5) ?>" class="b5-link"> <i class="icon-flecha-right"></i><span>Visitar
                            Blog</span></a>
                </div>
            </div>
