...
?>
<?php get_header(); ?>
<!-- <link rel="stylesheet" type="text/css" href="<?php //echo STATIC_URL ?>js/slick/slick.css"/> -->
...
<!-- BLOQUE 18 -->
<section class="b18" style="background-image: url('<?php echo $banner_intro_project ?>');">
    <div class="wancho">
        <a href="<?php echo get_site_url().'/proyectos-en-venta' ?>" class="b18-back-bottom"><i class="icon-fleha-left"></i></a>
    </div>
</section>
<?php endif ?>
<?php endif ?>
    ...
    <div class="wancho">
        ...
        <div class="b19-inner g3-move-up-2">
            ...
            <div class="b19-right">
                ...
                <div class="b19-list">
                    <a href="#form-cotizar" class="g0-btn ancla"><i class="icon-flecha-right"></i>Cotizar</a>
  ...
  <div class="wancho">
    ...
    <div class="b50-bottom g3-move-up-2">
      ...
      <div class="b50-right gallery-zoom">
        ...
        <?php if ($url_video): ?>
            <a href="<?php echo $url_video ?>" class="b10-play item-gallery"><span>Play</span></a>
        <?php endif ?>
      </div>
      <?php endif ?>
    </div>
                    ...
                    <div class="b22-slider">
                        ...
                        <div class="b22-item-sl" data-slide="<?php echo $key ?>">
                            <div class="b22-plano">
                                ...
                                <a href="<?php echo $image_plano ?>" class="b22-lupa b22-big-image"><i class="icon-mas"></i></a>
                            </div>
                        </div>
                        <?php endforeach ?>
                    </div>
                ...
                <div class="b12-formulario">
                    <form id="sd_form_project" method="post">
                        ...
                        <div class="g5-select g5-item-input">
                            <select id="form-tipology-project" name="currentTipology" class="form-input validate[required] b22-select-tipology">
                              <?php 
                                ...
                                ?>
                                  <option data-slide="<?php echo $key ?>" value="<?php echo $currentTipology ?>"><?php echo $currentTipology ?></option>
                                <?php endforeach ?>
                            </select>
                            <label class="input-label fijar" for="form-tipology-project"><span>Tipo</span><i class="icon-arrow-down"></i></label>
                        </div>
                        <?php endif ?>
                        ...
                        <div class="g5-input-two">
                            <div class="g5-input g5-item-input">
                                <input type="text"  id="form-email" name="your-email"  class="validate[required,custom[email]] form-input">
                        ...
                        <div class="g5-item-input g5-textarea">
                            ...
                            <label class="input-label" for="form_consulta"><span>¿Tienes algún comentario?</span></label>
                        </div>
                        ...
                        <div class="g5-terminos">
                            <input type="checkbox" checked id="form_project_privacity" class="validate[required]" name="agree-terms-privacity">
                            <label for="form_project_privacity" class="g5-terminos_nota"><span class="g5-terminos_icon"></span>
                                <div class="g5-terminos_text">
                                    <p>
                                       Acepto las  <a class="openPopupJS" target="_blank" href="<?php echo $privacy_policies ?>">Políticas de Privacidad  </a> y <a href="<?php echo $terms_conditions ?>">Términos y Condiciones</a> de Momento Grupo Inmobiliario.</p>
                                </div>
                            </label>
                        </div>
                        <div class="g0-cnt-btn">
                        ...
                        <input type="hidden" name="response_mailing_project" value="<?php echo $response_mailing_project ?>">
                    </form>
                </div> 
            </div>
        </div>
...
<?php get_footer(); ?>
<!-- <script src="<?php //echo STATIC_URL ?>js/slick/slick.min.js"></script> -->
        ...
        $('.b12-enviar').on('click', function(event) {
            event.preventDefault();
                ...
                if (!valid) {
                    ...
                    $.ajax({
                    // url: urlSite+'/wp-json/contact-form-7/v1/contact-forms/646/feedback',
