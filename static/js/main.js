...
/* BASE */
	...
	$('.h-open-menu').click(function(event) {
		...
		$('.b16').removeClass('hide');
		$('.b16').removeClass('moveleft');
		setTimeout(function(){
			$('.b16-menu-overlay').addClass('active');
			$('.b16').addClass('active');
			$('body').addClass('active');
	...
	$('.b16-close').click(function(event) {
		event.preventDefault();
		// $('.b11').removeClass('active');
		$('.b16').addClass('moveleft');
		$('.b16-menu-overlay').removeClass('active');
		setTimeout(function(){
			$('.b16').addClass('hide');
			$('.b16').removeClass('active');
			$('body').removeClass('active');
		},300)
	});
